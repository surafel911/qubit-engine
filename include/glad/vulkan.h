/**
 * Loader generated by glad 2.0.0-beta on Sat Apr  6 07:57:12 2019
 *
 * Generator: C/C++
 * Specification: vk
 * Extensions: 134
 ...
 *
 * Commandline:
 *    --api='vulkan=1.1' --extensions='VK_AMD_buffer_marker,VK_AMD_draw_indirect_count,VK_AMD_gcn_shader,VK_AMD_gpu_shader_half_float,VK_AMD_gpu_shader_int16,VK_AMD_mixed_attachment_samples,VK_AMD_negative_viewport_height,VK_AMD_rasterization_order,VK_AMD_shader_ballot,VK_AMD_shader_core_properties,VK_AMD_shader_explicit_vertex_parameter,VK_AMD_shader_fragment_mask,VK_AMD_shader_image_load_store_lod,VK_AMD_shader_info,VK_AMD_shader_trinary_minmax,VK_AMD_texture_gather_bias_lod,VK_ANDROID_external_memory_android_hardware_buffer,VK_EXT_acquire_xlib_display,VK_EXT_astc_decode_mode,VK_EXT_blend_operation_advanced,VK_EXT_conditional_rendering,VK_EXT_conservative_rasterization,VK_EXT_debug_marker,VK_EXT_debug_report,VK_EXT_debug_utils,VK_EXT_depth_range_unrestricted,VK_EXT_descriptor_indexing,VK_EXT_direct_mode_display,VK_EXT_discard_rectangles,VK_EXT_display_control,VK_EXT_display_surface_counter,VK_EXT_external_memory_dma_buf,VK_EXT_external_memory_host,VK_EXT_global_priority,VK_EXT_hdr_metadata,VK_EXT_inline_uniform_block,VK_EXT_post_depth_coverage,VK_EXT_queue_family_foreign,VK_EXT_sample_locations,VK_EXT_sampler_filter_minmax,VK_EXT_shader_stencil_export,VK_EXT_shader_subgroup_ballot,VK_EXT_shader_subgroup_vote,VK_EXT_shader_viewport_index_layer,VK_EXT_swapchain_colorspace,VK_EXT_validation_cache,VK_EXT_validation_flags,VK_EXT_vertex_attribute_divisor,VK_GOOGLE_display_timing,VK_IMG_filter_cubic,VK_IMG_format_pvrtc,VK_KHR_16bit_storage,VK_KHR_8bit_storage,VK_KHR_android_surface,VK_KHR_bind_memory2,VK_KHR_create_renderpass2,VK_KHR_dedicated_allocation,VK_KHR_descriptor_update_template,VK_KHR_device_group,VK_KHR_device_group_creation,VK_KHR_display,VK_KHR_display_swapchain,VK_KHR_draw_indirect_count,VK_KHR_driver_properties,VK_KHR_external_fence,VK_KHR_external_fence_capabilities,VK_KHR_external_fence_fd,VK_KHR_external_fence_win32,VK_KHR_external_memory,VK_KHR_external_memory_capabilities,VK_KHR_external_memory_fd,VK_KHR_external_memory_win32,VK_KHR_external_semaphore,VK_KHR_external_semaphore_capabilities,VK_KHR_external_semaphore_fd,VK_KHR_external_semaphore_win32,VK_KHR_get_display_properties2,VK_KHR_get_memory_requirements2,VK_KHR_get_physical_device_properties2,VK_KHR_get_surface_capabilities2,VK_KHR_image_format_list,VK_KHR_incremental_present,VK_KHR_maintenance1,VK_KHR_maintenance2,VK_KHR_maintenance3,VK_KHR_mir_surface,VK_KHR_multiview,VK_KHR_push_descriptor,VK_KHR_relaxed_block_layout,VK_KHR_sampler_mirror_clamp_to_edge,VK_KHR_sampler_ycbcr_conversion,VK_KHR_shader_atomic_int64,VK_KHR_shader_draw_parameters,VK_KHR_shared_presentable_image,VK_KHR_storage_buffer_storage_class,VK_KHR_surface,VK_KHR_swapchain,VK_KHR_variable_pointers,VK_KHR_vulkan_memory_model,VK_KHR_wayland_surface,VK_KHR_win32_keyed_mutex,VK_KHR_win32_surface,VK_KHR_xcb_surface,VK_KHR_xlib_surface,VK_MVK_ios_surface,VK_MVK_macos_surface,VK_NN_vi_surface,VK_NVX_device_generated_commands,VK_NVX_multiview_per_view_attributes,VK_NVX_raytracing,VK_NV_clip_space_w_scaling,VK_NV_compute_shader_derivatives,VK_NV_corner_sampled_image,VK_NV_dedicated_allocation,VK_NV_device_diagnostic_checkpoints,VK_NV_external_memory,VK_NV_external_memory_capabilities,VK_NV_external_memory_win32,VK_NV_fill_rectangle,VK_NV_fragment_coverage_to_color,VK_NV_fragment_shader_barycentric,VK_NV_framebuffer_mixed_samples,VK_NV_geometry_shader_passthrough,VK_NV_glsl_shader,VK_NV_mesh_shader,VK_NV_representative_fragment_test,VK_NV_sample_mask_override_coverage,VK_NV_scissor_exclusive,VK_NV_shader_image_footprint,VK_NV_shader_subgroup_partitioned,VK_NV_shading_rate_image,VK_NV_viewport_array2,VK_NV_viewport_swizzle,VK_NV_win32_keyed_mutex' c --loader
 *
 * Online:
 *    http://glad.sh/#api=vulkan%3D1.1&generator=c&options=LOADER
 *
 */
...
typedef enum VkAccessFlagBits {
    ...
    VK_ACCESS_ACCELERATION_STRUCTURE_READ_BIT_NVX = 2097152,
    VK_ACCESS_ACCELERATION_STRUCTURE_WRITE_BIT_NVX = 4194304
} VkAccessFlagBits;
...
typedef enum VkPipelineCreateFlagBits {
    ...
    VK_PIPELINE_CREATE_DEFER_COMPILE_BIT_NVX = 32
...
typedef enum VkShaderStageFlagBits {
    ...
    VK_SHADER_STAGE_RAYGEN_BIT_NVX = 256,
    VK_SHADER_STAGE_ANY_HIT_BIT_NVX = 512,
    VK_SHADER_STAGE_CLOSEST_HIT_BIT_NVX = 1024,
    VK_SHADER_STAGE_MISS_BIT_NVX = 2048,
    VK_SHADER_STAGE_INTERSECTION_BIT_NVX = 4096,
    VK_SHADER_STAGE_CALLABLE_BIT_NVX = 8192,
...
typedef enum VkPipelineStageFlagBits {
    ...
    VK_PIPELINE_STAGE_RAYTRACING_BIT_NVX = 2097152,
...
typedef enum VkGeometryFlagBitsNVX {
    VK_GEOMETRY_OPAQUE_BIT_NVX = 1,
    VK_GEOMETRY_NO_DUPLICATE_ANY_HIT_INVOCATION_BIT_NVX = 2
} VkGeometryFlagBitsNVX;
typedef enum VkGeometryInstanceFlagBitsNVX {
    VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_DISABLE_BIT_NVX = 1,
    VK_GEOMETRY_INSTANCE_TRIANGLE_CULL_FLIP_WINDING_BIT_NVX = 2,
    VK_GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT_NVX = 4,
    VK_GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT_NVX = 8
} VkGeometryInstanceFlagBitsNVX;
typedef enum VkBuildAccelerationStructureFlagBitsNVX {
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_UPDATE_BIT_NVX = 1,
    VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_COMPACTION_BIT_NVX = 2,
    VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_TRACE_BIT_NVX = 4,
    VK_BUILD_ACCELERATION_STRUCTURE_PREFER_FAST_BUILD_BIT_NVX = 8,
    VK_BUILD_ACCELERATION_STRUCTURE_LOW_MEMORY_BIT_NVX = 16
...
GLAD_API_CALL int GLAD_VK_KHR_mir_surface;
...
GLAD_API_CALL int GLAD_VK_NVX_raytracing;
...
typedef VkResult (GLAD_API_PTR *PFN_vkBindAccelerationStructureMemoryNVX)(VkDevice   device, uint32_t   bindInfoCount, const  VkBindAccelerationStructureMemoryInfoNVX *  pBindInfos);
...
typedef void (GLAD_API_PTR *PFN_vkCmdCopyAccelerationStructureNVX)(VkCommandBuffer   commandBuffer, VkAccelerationStructureNVX   dst, VkAccelerationStructureNVX   src, VkCopyAccelerationStructureModeNVX   mode);
...
typedef void (GLAD_API_PTR *PFN_vkCmdWriteAccelerationStructurePropertiesNVX)(VkCommandBuffer   commandBuffer, VkAccelerationStructureNVX   accelerationStructure, VkQueryType   queryType, VkQueryPool   queryPool, uint32_t   query);
...
typedef VkResult (GLAD_API_PTR *PFN_vkCompileDeferredNVX)(VkDevice   device, VkPipeline   pipeline, uint32_t   shader);
typedef VkResult (GLAD_API_PTR *PFN_vkCreateAccelerationStructureNVX)(VkDevice   device, const  VkAccelerationStructureCreateInfoNVX *  pCreateInfo, const  VkAllocationCallbacks *  pAllocator, VkAccelerationStructureNVX *  pAccelerationStructure);
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
...
#endif
#if defined(VK_USE_PLATFORM_MIR_KHR)
typedef VkResult (GLAD_API_PTR *PFN_vkCreateMirSurfaceKHR)(VkInstance   instance, const  VkMirSurfaceCreateInfoKHR *  pCreateInfo, const  VkAllocationCallbacks *  pAllocator, VkSurfaceKHR *  pSurface);
...
typedef VkResult (GLAD_API_PTR *PFN_vkCreateRaytracingPipelinesNVX)(VkDevice   device, VkPipelineCache   pipelineCache, uint32_t   createInfoCount, const  VkRaytracingPipelineCreateInfoNVX *  pCreateInfos, const  VkAllocationCallbacks *  pAllocator, VkPipeline *  pPipelines);
...
typedef void (GLAD_API_PTR *PFN_vkDestroyAccelerationStructureNVX)(VkDevice   device, VkAccelerationStructureNVX   accelerationStructure, const  VkAllocationCallbacks *  pAllocator);
...
typedef VkResult (GLAD_API_PTR *PFN_vkGetAccelerationStructureHandleNVX)(VkDevice   device, VkAccelerationStructureNVX   accelerationStructure, size_t   dataSize, void *  pData);
typedef void (GLAD_API_PTR *PFN_vkGetAccelerationStructureMemoryRequirementsNVX)(VkDevice   device, const  VkAccelerationStructureMemoryRequirementsInfoNVX *  pInfo, VkMemoryRequirements2KHR *  pMemoryRequirements);
typedef void (GLAD_API_PTR *PFN_vkGetAccelerationStructureScratchMemoryRequirementsNVX)(VkDevice   device, const  VkAccelerationStructureMemoryRequirementsInfoNVX *  pInfo, VkMemoryRequirements2KHR *  pMemoryRequirements);
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
...
#if defined(VK_USE_PLATFORM_MIR_KHR)
typedef VkBool32 (GLAD_API_PTR *PFN_vkGetPhysicalDeviceMirPresentationSupportKHR)(VkPhysicalDevice   physicalDevice, uint32_t   queueFamilyIndex, MirConnection *  connection);
...
#endif
typedef VkResult (GLAD_API_PTR *PFN_vkGetRaytracingShaderHandlesNVX)(VkDevice   device, VkPipeline   pipeline, uint32_t   firstGroup, uint32_t   groupCount, size_t   dataSize, void *  pData);
...
GLAD_API_CALL PFN_vkBindAccelerationStructureMemoryNVX glad_vkBindAccelerationStructureMemoryNVX;
#define vkBindAccelerationStructureMemoryNVX glad_vkBindAccelerationStructureMemoryNVX
...
GLAD_API_CALL PFN_vkCmdBuildAccelerationStructureNVX glad_vkCmdBuildAccelerationStructureNVX;
#define vkCmdBuildAccelerationStructureNVX glad_vkCmdBuildAccelerationStructureNVX
...
GLAD_API_CALL PFN_vkCmdCopyAccelerationStructureNVX glad_vkCmdCopyAccelerationStructureNVX;
#define vkCmdCopyAccelerationStructureNVX glad_vkCmdCopyAccelerationStructureNVX
...
GLAD_API_CALL PFN_vkCmdTraceRaysNVX glad_vkCmdTraceRaysNVX;
#define vkCmdTraceRaysNVX glad_vkCmdTraceRaysNVX
...
GLAD_API_CALL PFN_vkCmdWriteAccelerationStructurePropertiesNVX glad_vkCmdWriteAccelerationStructurePropertiesNVX;
#define vkCmdWriteAccelerationStructurePropertiesNVX glad_vkCmdWriteAccelerationStructurePropertiesNVX
...
GLAD_API_CALL PFN_vkCompileDeferredNVX glad_vkCompileDeferredNVX;
#define vkCompileDeferredNVX glad_vkCompileDeferredNVX
GLAD_API_CALL PFN_vkCreateAccelerationStructureNVX glad_vkCreateAccelerationStructureNVX;
#define vkCreateAccelerationStructureNVX glad_vkCreateAccelerationStructureNVX
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
...
#endif
#if defined(VK_USE_PLATFORM_MIR_KHR)
GLAD_API_CALL PFN_vkCreateMirSurfaceKHR glad_vkCreateMirSurfaceKHR;
#define vkCreateMirSurfaceKHR glad_vkCreateMirSurfaceKHR
...
GLAD_API_CALL PFN_vkCreateRaytracingPipelinesNVX glad_vkCreateRaytracingPipelinesNVX;
#define vkCreateRaytracingPipelinesNVX glad_vkCreateRaytracingPipelinesNVX
...
GLAD_API_CALL PFN_vkDestroyAccelerationStructureNVX glad_vkDestroyAccelerationStructureNVX;
#define vkDestroyAccelerationStructureNVX glad_vkDestroyAccelerationStructureNVX
...
GLAD_API_CALL PFN_vkGetAccelerationStructureHandleNVX glad_vkGetAccelerationStructureHandleNVX;
#define vkGetAccelerationStructureHandleNVX glad_vkGetAccelerationStructureHandleNVX
GLAD_API_CALL PFN_vkGetAccelerationStructureMemoryRequirementsNVX glad_vkGetAccelerationStructureMemoryRequirementsNVX;
#define vkGetAccelerationStructureMemoryRequirementsNVX glad_vkGetAccelerationStructureMemoryRequirementsNVX
GLAD_API_CALL PFN_vkGetAccelerationStructureScratchMemoryRequirementsNVX glad_vkGetAccelerationStructureScratchMemoryRequirementsNVX;
#define vkGetAccelerationStructureScratchMemoryRequirementsNVX glad_vkGetAccelerationStructureScratchMemoryRequirementsNVX
#if defined(VK_USE_PLATFORM_ANDROID_KHR)
...
#if defined(VK_USE_PLATFORM_MIR_KHR)
GLAD_API_CALL PFN_vkGetPhysicalDeviceMirPresentationSupportKHR glad_vkGetPhysicalDeviceMirPresentationSupportKHR;
#define vkGetPhysicalDeviceMirPresentationSupportKHR glad_vkGetPhysicalDeviceMirPresentationSupportKHR
...
#endif
GLAD_API_CALL PFN_vkGetRaytracingShaderHandlesNVX glad_vkGetRaytracingShaderHandlesNVX;
#define vkGetRaytracingShaderHandlesNVX glad_vkGetRaytracingShaderHandlesNVX
